...
import com.ming.toolkits.util.ToastUtil;
   ...
   // final AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (key.equals("charge_on"))
        {
            ...
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/off/off /system/media/audio/ui/charging.ogg",true);
            }
            else
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/power/charging /system/media/audio/ui/charging.ogg",true);
            }
        ...
        if (key.equals("charge_off"))
        {
            ...
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/off/off /system/media/audio/ui/disconnect.ogg",true);
            }
            else
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/power/disconnect /system/media/audio/ui/disconnect.ogg",true);
            }
        }
        if (key.equals("low_power"))
        {
            ...
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/off/off /system/media/audio/ui/LowBattery.ogg",true);
            }
            else
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/power/LowBattery /system/media/audio/ui/LowBattery.ogg",true);
            }
        }
        if (key.equals("charge_wireless"))
        {
            ...
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/off/off /system/media/audio/ui/charge_wireless.ogg",true);
            }
            else
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/power/charge_wireless /system/media/audio/ui/charge_wireless.ogg",true);
            }
        }
        if (key.equals("Bird_Notification"))
        {
            ...
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/off/off /system/media/audio/ui/BirdCicada_preview.ogg",true);
            }
            else
            {
                ShellUtils.execCommand("cp /system/xbin/Ming/Audio/power/BirdCicada_preview /system/media/audio/ui/BirdCicada_preview.ogg",true);
...
//                                    {
//                                        mount();
//                                        ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"quick_settings_num_columns\"/d' /system/xbin/Ming/Theme/systemui/theme_values.xml",true);
//                                        ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"quick_settings_num_columns\\\">" + x +"<\\/integer>/\" /system/xbin/Ming/Theme/systemui/theme_values.xml",true);
//                                        ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"quick_settings_num_rows\"/d' /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                                        ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"quick_settings_num_rows\\\">" + y +"<\\/integer>/\" /system/xbin/Ming/Theme/systemui/theme_values.xml",true);
//                                        ShellUtils.execCommand("cd /system/xbin/Ming/Theme/systemui\n/system/xbin/zip /system/media/theme/default/com.android.systemui theme_values.xml",true);
//
...
//                            mount();
//                            ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"quick_settings_num_columns\"/d' /system/xbin/Ming/Theme/systemui/theme_values.xml",true);
//                            ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"quick_settings_num_columns\\\">" + 4 +"<\\/integer>/\" /system/xbin/Ming/Theme/systemui/theme_values.xml",true);
//                            ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"quick_settings_num_rows\"/d' /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                            ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"quick_settings_num_rows\\\">" + 3 +"<\\/integer>/\" /system/xbin/Ming/Theme/systemui/theme_values.xml",true);
//                            ShellUtils.execCommand("cd /system/xbin/Ming/Theme/systemui\n/system/xbin/zip /system/media/theme/default/com.android.systemui theme_values.xml",true);
//
//                            ShellUtils.execCommand("/system/xbin/busybox killall com.android.systemui", true);
//
...
//                                    {
//                                        mount();
//                                        ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"config_cell_count_y\"/d' /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                                        ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"config_cell_count_y\\\">" + y +"<\\/integer>/\" /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                                        ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"config_cell_count_x\"/d' /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                                        ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"config_cell_count_x\\\">" + x +"<\\/integer>/\" /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                                        ShellUtils.execCommand("cd /system/xbin/Ming/Theme/home\n/system/xbin/zip /system/media/theme/default/com.miui.home theme_values.xml",true);
//
//                                        Toast.makeText(getActivity(),  desktop_x.getText()+"出现异常,请重新输入", Toast.LENGTH_SHORT).show();
//                                    }
//                                    catch (NumberFormatException e)
...
//                            mount();
//                            ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"config_cell_count_y\"/d' /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                            ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"config_cell_count_y\\\">" + 6 +"<\\/integer>/\" /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                            ShellUtils.execCommand("/system/xbin/busybox sed -i '/integer name=\"config_cell_count_x\"/d' /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                            ShellUtils.execCommand("/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <integer name=\\\"config_cell_count_x\\\">" + 4 +"<\\/integer>/\" /system/xbin/Ming/Theme/home/theme_values.xml",true);
//                            ShellUtils.execCommand("cd /system/xbin/Ming/Theme/home\n/system/xbin/zip /system/media/theme/default/com.miui.home theme_values.xml",true);
//
//                            try {
//                                forceStopApp("com.miui.home");
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            switch (value)
                            {
                                ...
                                case 1:
                                    ...
                                    //ShellUtils.execCommand("chmod 777 /system/xbin/Ming/Animation/Mi10",true);
                                    //ShellUtils.execCommand("cd /system/xbin/Ming/Animation/Mi10\n/system/xbin/zip /system/priv-app/MiuiSystemUI/MiuiSystemUI.apk res/raw/*",true);
...
//                                    //ShellUtils.execCommand("chmod 644 /system/priv-app/MiuiSystemUI/MiuiSystemUI.apk",true);
        ...
        if (key.equals("brevent_active"))
        {
            ...
            {
                //ShellUtils.execCommand("sh /system/xbin/Ming/Brevent_on.sh",true);
            ...
            {
                //ShellUtils.execCommand("sh /system/xbin/Ming/Brevent_off.sh",true);
        ...
        if(key.equals("power_advanced"))
        {
            ...
            {
                    String[] a = new String[]{"cp /system/xbin/Ming/ad_powermenu /system/media/theme/default/powermenu", "chmod -R 0644 /system/media/theme/default/powermenu"};
                    ShellUtils.execCommand(a, true);
            }

            else
            {
                    String[] a = new String[]{"cp /system/xbin/Ming/powermenu /system/media/theme/default/powermenu", "chmod -R 0644 /system/media/theme/default/powermenu"};
                    ShellUtils.execCommand(a, true);
            }
            reboot();
